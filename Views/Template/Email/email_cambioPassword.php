		...
		<tbody>
			...
			<tr>
				<td>
					...
					<p>Para restablecer tu contaseña, click en el boton de abajo. </p>
					<p class="x_text_white">
					<a href="<?= $data['url_recovery']; ?>" target="_blank" class="x_button_link x_link_blue">Restablecer contraseña</a>
					</p>
					<br>
